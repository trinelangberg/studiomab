...
<html lang="en">
  <head>
	...
	<meta name="description" content="Project Forrest House, Center of Jutland">
    <!-- Bootstrap -->
  ...
  <body>
	  ...
	  <?php $page = 'forresthouse'; include 'includes/menu.php';?>
...
<!-- HEADER END -->
	  ...
	  <div class="img-projects">
		  	<h1 id="forrest-h">FORREST HOUSE, CENTER OF JUTLAND</h1>
			  <img src="images/forresthouse.jpg" alt="Project Forrest House" width="100%">
			  <img src="images/forrestsketch.jpg" alt="Sketch of project Forrest House" width="100%">
	  </div>
	</div>
