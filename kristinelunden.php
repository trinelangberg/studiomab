...
<html lang="en">
  <head>
	...
	<meta name="description" content="Project Kristinelunden, a modern architectural designed family house">
    <!-- Bootstrap -->
  ...
  <body>
	  ...
	  <?php $page = 'kristinelunden'; include 'includes/menu.php';?>
...
<!-- HEADER END -->
	  ...
	  <div class="img-projects">
		  	 <h1 id="kristine-h1">KRISTINELUNDEN - MODERN ARCHITECTURAL <br> DESIGNED FAMILY HOUSE</h1>
		  	  <h2 id="kristine">houses in the central Jutland in close relationship<br> between architecture and the free nature</h2>
			  <img src="images/kristinelunden.jpg" alt="Project Kristinelunden" width="100%">
			  <img src="images/kristinelunden-map.jpg" alt="Kristinelunden map seen from above" width="100%">
	  </div>
	</div>
