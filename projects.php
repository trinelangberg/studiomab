...
<html lang="en">
  <head>
	...
	<meta name="description" content="StudioMAB aims to create a lasting social, economic and enviromental effect with every project they take upon them.">
    <!-- Bootstrap -->
  ...
  <body>
	  ...
	  <?php $page = 'cityappartment'; include 'includes/menu.php';?>
